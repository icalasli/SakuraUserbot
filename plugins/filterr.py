...
@register(outgoing=True, pattern=r"^xfltr (.*)")
async def add_new_filter(new_handler):
    ...
    if add_filter(str(new_handler.chat_id), keyword, string, msg_id) is True:
        await new_handler.edit(success.format(keyword, 'kak'))
    else:
        await new_handler.edit(success.format(keyword, 'kak'))


@register(outgoing=True, pattern=r"^xstp (.*)")
...
@register(outgoing=True, pattern="^xclrallbot (.*)")
...
@register(outgoing=True, pattern="^xfltrs$")
...
CMD_HELP.update({
    ...
    \n\n`xfltr` <keyword> <balasan> atau balas ke pesan ketik xfltr <keyword>\

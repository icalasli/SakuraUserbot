...
async def _(e):
    ...
    if m:
        ...
        await xx.edit(
            f'<code>𝙞𝙘𝙡𝙭𝙪𝙨𝙚𝙧𝙗𝙤𝙩 anda </code><strong>sudah versi terbaru</strong><code> dengan </code><strong><a href="https://github.com/levina-lab/SakuraUserbot/tree/{branch}">[{branch}]</a></strong>',
            parse_mode="html",
            link_preview=False,
        )
